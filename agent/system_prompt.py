...
from agent.prompt_builder import (
    ...
    MODEL_SWITCH_GUIDANCE, PARALLEL_TOOL_CALL_GUIDANCE, PLATFORM_HINTS,
    REASONING_EFFORT_GUIDANCE, SESSION_SEARCH_GUIDANCE,
...
def _tool_guidance_block(agent: Any) -> Optional[str]:
    ...
    tool_guidance = [
        ...
        # Static text only: runtime dial values never enter the byte-stable prompt.
        REASONING_EFFORT_GUIDANCE if "reasoning_effort" in names else None,
        MODEL_SWITCH_GUIDANCE if "model_switch" in names else None,
        _kanban_guidance,
    ]

    ...
    for msg in messages:
        if (
            ...
            if isinstance(prev_content, str) and isinstance(new_content, str):
                ...
                # Same sidecar invariant as the str branch: a degenerate merge
                # (empty ``new_content``) yields parts identical to the
                # original list and must not count as a rewrite.
            ...
            # the later turn's content is ``None``, or a multimodal merge
            # whose parts come out identical to the original list; a falsy
            # ``new_content`` that

...
def init_agent(
    ...
    # True only when the active value came from a session/runtime override.
    # Model switches preserve such overrides; otherwise they re-resolve the
    # destination model's configured effort.

...
class AIAgent(
    ...
    def __init__(
        ...
        read_terminal_callback: callable = None, reasoning_update_callback: callable = None,
        model_update_callback: callable = None, read_preview_callback: callable = None,
        ...
        reasoning_config_is_runtime_override: bool = False, service_tier: str = None,

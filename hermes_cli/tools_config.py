...
#
# Reasoning effort + model_switch are opt-in: deliberately NOT default core schema (a new default entry is
# permanent footprint on every request — AGENTS.md footprint ladder); enable per platform via `hermes tools`.
# kanban is upstream default-off (opt-in board).
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "a2a", "reasoning", "model_switch", "kanban"}

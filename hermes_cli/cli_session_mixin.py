...
class CLISessionMixin:
    ...
    def new_session(self, silent=False, title=None):
        ...
        # Resolve after the model reset so the fresh session receives the effective model's
        # per-model override, falling back to the global configured effort only when none exists.

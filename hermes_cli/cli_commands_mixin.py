...
class CLICommandsMixin:
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        # Session-scoped effort must outrank per-model/global config if the session later switches
        # models. A successful --global write returns to normal config precedence; a failed write
        # remains session-scoped.
        self._reasoning_config_is_runtime_override = not saved
        if saved:
